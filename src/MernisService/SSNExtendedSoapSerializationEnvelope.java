...
public class SSNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(SSNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SSNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SSNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SSNDateTimeConverter dateTimeConverter = new SSNStandardDateTimeConverter();

    public SSNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SSNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SSNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SSNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SSNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SSNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
