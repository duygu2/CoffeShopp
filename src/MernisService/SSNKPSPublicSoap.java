...
public class SSNKPSPublicSoap
{
    ...
    public SSNKPSPublicSoap(){}

    public SSNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public SSNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SSNExtendedSoapSerializationEnvelope envelope= new SSNExtendedSoapSerializationEnvelope(SSNExtendedSoapSerializationEnvelope.VER11);
